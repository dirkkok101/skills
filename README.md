...
Run `/plugin` in Claude Code, go to the **Installed** tab. You should see version **1.8.0** or higher.
...
4. **Verify installation:** Run `/plugin`, check the **Installed** tab shows version 1.8.0+
